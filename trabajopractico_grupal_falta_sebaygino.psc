...
SubProceso ventaquincena(articulos,n)
	...
	Para i<-1 Hasta n Con Paso 1 Hacer
		...
		Segun articulos[i,3] Hacer
			"Tornillos y tuercas":
				primeraquincenat=primeraquincenat+vqp;
				segundaquincenat=segundaquincenat+vqs;
				vqptornillos=primeraquincenat/(primeraquincenat+segundaquincenat)*100;
				vqstornillos=segundaquincenat/(primeraquincenat+segundaquincenat)*100;
			"Adhesivos":
...
SubProceso mayor_importe(articulos,n)
	...
	Para i<-1 Hasta n Con Paso 1 Hacer
		...
		Segun articulos[i,3] Hacer
			"Tornillos y tuercas":
				pqtornillos=pqtornillos+auxp;
				sqtornillos=sqtornillos+auxs;
				pqpretornillos=pqpretornillos+(pqtornillos*auxprecio);
				sqpretornillos=sqpretornillos+(sqtornillos*auxprecio);
				arreglosubmenu[1,1]=pqpretornillos;
				arreglosubmenu[1,2]=sqpretornillos;
			"Adhesivos":
